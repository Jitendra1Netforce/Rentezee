...
public class AddressFragment extends Fragment implements  View.OnClickListener
{
       ...
       public static   RelativeLayout relativeEmptyAddress;
        ...
        user_id = Long.toString(userId);
         ...
         relativeEmptyAddress   = (RelativeLayout)   view.findViewById(R.id.relativeEmptyAddress);
            ...
            txtViewAddress.setOnClickListener(new View.OnClickListener() {
                ...
                txtAddAddressHeading.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        {
                            System.out.println("size------------"+addressdata.size());
                        ...
                        {
                            System.out.println("size2------------"+addressdata.size());
