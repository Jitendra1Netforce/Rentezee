...
public class ChooseAddressActivity extends SimpleActivity
{
    ...
    long userId;
    User user;
    public  RelativeLayout relativeBottomLayout,relativeEmptyAddress;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        relativeEmptyAddress = (RelativeLayout) findViewById(R.id.relativeEmptyAddress);
            ...
            public void onClick(View view) {
                ...
                if (txtAddAddressHeading.getText().toString().equals("+ Add Address"))
                {
                    ...
                    if(addressdata.size()==0)
                    {
                        ...
                        relativeEmptyAddress.setVisibility(View.INVISIBLE);
                ...
                else
                {
                    ...
                    if(addressdata.size()== 0)
                    {
                        relativeEmptyAddress.setVisibility(View.VISIBLE);
                    ...
                    if (!city_d.isEmpty())
                    {
                        ...
                        if (!pin.isEmpty())
                        {
                            ...
                            if (pin_length == 6)
                            {
                                ...
                                Ion.with(context)
                                        .load("https://netforcesales.com/renteeze/webservice/Users/addresses")
    ...
    public  void reset() {
        ...
        Ion.with(context)
                .load("https://netforcesales.com/renteeze/webservice/Users/address_list")
                .setJsonObjectBody(jsonObject)
                .asJsonObject()
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if (result != null)
                        {
                            ...
                            rentenzee_credit_amount  = credit;
