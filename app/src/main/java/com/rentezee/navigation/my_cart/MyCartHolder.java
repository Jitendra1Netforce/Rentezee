...
public class MyCartHolder extends RecyclerView.ViewHolder
{
        ...
        TextView tvProductName,tvCategoriesName,tvRentPrice,tvSecurytiFee,tvItemTotal;
        TextView tvRentalHeading,tvsecurityheading,tvrentDurationHeading,tv_to,tvItemTotalHeading,tvTotalSecurity;
