...
public class PastOrderFragment extends Fragment implements  View.OnClickListener
{
    ...
    long  userId;
    User user;
    RelativeLayout relativeEmptyOrder;
    String price;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        buttonMyOrder = (Button)  view.findViewById(R.id.buttonMyOrder);

        relativeEmptyOrder = (RelativeLayout) view.findViewById(R.id.relativeEmptyOrder);
        ...
        buttonMyOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), DashboardContainer.class);
    ...
    private void reset()
    {
        relativeEmptyOrder.setVisibility(View.INVISIBLE);
        ...
        Ion.with(this)
                .load("https://netforcesales.com/renteeze/webservice/Orders/orderlist")
                ...
                .setCallback(new FutureCallback<JsonObject>() {
                    ...
                    public void onCompleted(Exception e, JsonObject result) {
                        if (result != null)
                        {
                            ...
                            {
                                relativeEmptyOrder.setVisibility(View.VISIBLE);
                                recyclerviewPastOrder.setVisibility(View.INVISIBLE);
                            ...
                            for (int i = 0; i < productListArray.size(); i++)
                            {
                                ...
                                try
                                {
                                    ...
                                    String delivery_date = jsonObject.get("deliveri_date").getAsString();
                                ...
                                pastOrderDatas.add(new PastOrderData("", order_date, price, product_status,order_number,delivery_date));
